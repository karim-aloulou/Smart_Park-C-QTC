...
void MainWindow2::on_tri_croissant_clicked()
{Notification n;

    ui->tab_visiteur->setModel(V.tricroissant());
}

void MainWindow2::on_tri_decroissant_clicked()
{
...
void MainWindow2::on_combo_box_crit_currentTextChanged(const QString &arg1)
{
...
void MainWindow2::on_recherche_id_v_textChanged(const QString &arg1)
{
    QSqlQueryModel *model= new QSqlQueryModel();
               QSqlQuery   *query= new QSqlQuery();
...
void MainWindow2::on_recherche_tel_textEdited(const QString &arg1)
{
    QSqlQueryModel *model= new QSqlQueryModel();
               QSqlQuery   *query= new QSqlQuery();
...
void MainWindow2::on_generer_pdf_clicked()
{
...
/*void MainWindow2::on_sendBtn_clicked()
{
