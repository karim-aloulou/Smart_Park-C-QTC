...
{
id=0; date=" / / "; heure= " : "; type_parking="";
}
Reservation::Reservation(int id, QString date ,QString heure, QString type_parking,QString id_v)
{
    this->id=id;
 ...
 QString Reservation::getid_v(){return id_v;}
 ...
 void Reservation ::setid_v(QString id_v){this->id_v=id_v;}
...
bool Reservation::modifier(int id ,QString D,QString H,QString t,QString id_v )
{
QSqlQuery query;
